...
public class Client2 extends JFrame implements MouseListener,Runnable{

	public static void main(String[] args) throws IOException {
		JFrame startscreen = new JFrame("Co caro 2");
	...
	public void showresult(String s, Vector<Point> d) {
		...
		JFrame gameover = new JFrame("Ca caro - Player 2 - Tro choi ket thuc");
	...
	public Client2() {
		this.setTitle("Co Caro - Player 2");
	...
	public void run() {
		while(true) {
			try {
				/*
				 * DataInputStream dis = new DataInputStream(soc.getInputStream()); int ix =
				 * Integer.parseInt(dis.readUTF()); int iy = Integer.parseInt(dis.readUTF());
				 */
